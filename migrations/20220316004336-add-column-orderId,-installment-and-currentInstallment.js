...
module.exports = {
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.removeColumn('BoughtHistories', 'orderId', {})
    await queryInterface.removeColumn('BoughtHistories', 'installment', {})
    await queryInterface.removeColumn('BoughtHistories', 'currentInstallment', {})
  }
};
